...
const FilterModel = ({isVisible, onClose}) => {
    ...
    const [showFilterModel,
        setShowFilterModel] = useState(isVisible);

    const [deliveryTime,
        setDeliveryTime] = useState("");
    const [ratings,
        setRatings] = useState("");
    const [tags,
        setTags] = useState("");
                        ...
                        <Animated.View
                            ...
                            <View
                                ...
                                <IconButton
                                    ...
                                    onPress={() => setShowFilterModel(false)}></IconButton>
                            </View>
                            <ScrollView
